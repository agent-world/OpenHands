...
from openhands.resolver.plan_resolver import PlanResolver
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description='Create a plan to resolve a single issue.')
    parser.add_argument(
        '--selected-repo',
        type=str,
        required=True,
    ...
    parser.add_argument(
        ...
        type=int,
        required=True,
        help='Issue number to create a plan for.',
    )
    parser.add_argument(
        '--comment-id',
        type=int_or_none,
        required=False,
        default=None,
        help='Create a plan for a specific comment',
    )
    parser.add_argument(
        '--output-dir',
        type=str,
    ...
    parser.add_argument(
        ...
        default='issue',
        choices=['issue', 'pr'],
        help='Type of issue to create a plan for, either open issue or pr comments.',
    )
    parser.add_argument(
        '--is-experimental',
    ...
    plan_resolver = PlanResolver(my_args)
    asyncio.run(plan_resolver.resolve_issue())
